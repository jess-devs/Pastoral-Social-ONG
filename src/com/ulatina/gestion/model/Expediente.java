...
public class Expediente implements Serializable {
    ...
    public Date getFechaPrevistaConclusion() { return fechaPrevistaConclusion; }
    public void setFechaPrevistaConclusion(Date fechaPrevistaConclusion) { this.fechaPrevistaConclusion = fechaPrevistaConclusion; }

    public Date getFechaConclusionReal() { return fechaConclusionReal; }
    public void setFechaConclusionReal(Date fechaConclusionReal) { this.fechaConclusionReal = fechaConclusionReal; }
    ...
    public String getColorMarcador() { return colorMarcador; }
    public void setColorMarcador(String colorMarcador) { this.colorMarcador = colorMarcador; }

    public EstadoExpediente getEstado() { return estado; }
    public void setEstado(EstadoExpediente estado) { this.estado = estado; }

    public EtapaExpediente getEtapaActual() { return etapaActual; }
    public void setEtapaActual(EtapaExpediente etapaActual) { this.etapaActual = etapaActual; }
    ...
    public List<DocumentoAdjunto> getDocumentosAdjuntos() { return documentosAdjuntos; }
    public void setDocumentosAdjuntos(List<DocumentoAdjunto> documentosAdjuntos) { this.documentosAdjuntos = documentosAdjuntos; }

    public List<ProlongacionAyuda> getProlongacionesAyuda() { return prolongacionesAyuda; }
    public void setProlongacionesAyuda(List<ProlongacionAyuda> prolongacionesAyuda) { this.prolongacionesAyuda = prolongacionesAyuda; }

    public List<AsistenciaSolicitada> getAsistenciasSolicitadas() { return asistenciasSolicitadas; }
    public void setAsistenciasSolicitadas(List<AsistenciaSolicitada> asistenciasSolicitadas) { this.asistenciasSolicitadas = asistenciasSolicitadas; }
