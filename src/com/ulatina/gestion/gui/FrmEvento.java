...
public class FrmEvento extends JPanel {
    ...
    private JPanel crearBarraBusqueda() {
        ...
        // Texto de placeholder que guía al usuario sobre qué puede buscar
        ...
        // FocusListener simula el comportamiento de un placeholder:
        // borra el texto guía cuando el usuario hace clic, y lo restaura si se va sin escribir
        ...
        // DocumentListener detecta cada cambio en el campo de texto en tiempo real
        // y llama a filtrarTexto() para actualizar la tabla automáticamente
    ...
    private JPanel crearPanelTabla() {
        ...
        tabla.setSelectionBackground(AppColors.FILA_SEL); // Color de fondo al seleccionar una fila
    ...
    private static class TipoBadgeRenderer extends DefaultTableCellRenderer {
        ...
        private static Color tipoColor(String tipo, boolean foreground) {
            switch (tipo) {
                case "REUNION":
                    return foreground ? new Color(0x1E40AF) : new Color(0xDBEAFE); // Azul
                case "CAPACITACION":
                    return foreground ? new Color(0x166534) : new Color(0xDCFCE7); // Verde
                case "ENTREGA":
                    return foreground ? new Color(0x92400E) : new Color(0xFEF3C7); // Amarillo/naranja
                case "CELEBRACION":
                    return foreground ? new Color(0x6D28D9) : new Color(0xEDE9FE); // Morado
                default: // OTRO
                    return foreground ? new Color(0x374151) : new Color(0xF3F4F6); // Gris
            }
        }
    }
}