...
public class FrmExpedientes extends JFrame {
  ...
  private JPanel crearPanelInfoBar() {
    ...
    btnVerEditar = UIFactory.crearBotonSmall(
      "Ver / Editar",
      AppColors.AZUL,
      Color.WHITE
    );
    ...
    btnNuevoInfo = UIFactory.crearBotonSmall(
      "Eliminar",
      AppColors.ROJO,
      Color.WHITE
    );
  ...
  private JPanel crearBarraBusqueda() {
    ...
    JButton btnFiltros = UIFactory.crearBoton(
      "Filtros",
      AppColors.GRIS_BTN,
      AppColors.TEXTO
    );
    ...
    JButton btnNuevo = UIFactory.crearBoton(
      "+ Nuevo",
      AppColors.PRIMARIO,
      Color.WHITE
    );
