...
public class FrmLogin extends JFrame {
  ...
  private JPanel crearPanelLogin() {
    ...
    JButton btnIngresar = UIFactory.crearBoton(
      "Ingresar",
      AppColors.PRIMARIO,
      Color.WHITE,
      e -> accionLogin()
    ...
    p.add(
      UIFactory.crearBotonLink("Crear una cuenta nueva", e ->
        mostrar(VISTA_REGISTRO)
      )
    );
    p.add(vspace(6));
    p.add(
      UIFactory.crearBotonLink("Olvidé mi contraseña", e ->
        mostrar(VISTA_RECUPERAR)
      )
    );
  ...
  private JPanel crearPanelRegistro() {
    ...
    JButton btnCrear = UIFactory.crearBoton(
      "Crear cuenta",
      AppColors.PRIMARIO,
      Color.WHITE,
      e -> accionRegistrar()
    ...
    p.add(vspace(12));
    p.add(
      UIFactory.crearBotonLink("Volver al inicio de sesión", e ->
        mostrar(VISTA_LOGIN)
      )
    );
  ...
  private JPanel crearPanelRecuperar() {
    ...
    JLabel info = new JLabel(
      "Ingrese su correo y defina una nueva contraseña."
    );
    ...
    JButton btnReset = UIFactory.crearBoton(
  ...
  private void mostrar(String vista) {
    ...
    int alto = VISTA_LOGIN.equals(vista)
      ? 480
      : VISTA_REGISTRO.equals(vista)
        ? 580
        : 530;
    setSize(440, alto);
    setLocationRelativeTo(null);
