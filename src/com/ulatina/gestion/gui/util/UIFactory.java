...
public final class UIFactory {
  ...
  public static JButton crearBoton(
    ...
    JButton btn = new JButton(texto) {
      ...
      protected void paintComponent(Graphics g) {
        ...
        g2.fill(
          new RoundRectangle2D.Float(0, 0, getWidth(), getHeight(), 8, 8)
        );
        g2.dispose();
  ...
  public static JButton crearBotonSmall(
    String texto,
    Color bg,
    Color fg,
    ActionListener accion
   ...
   */
  public static JButton crearBotonDialog(
    String texto,
    Color bg,
    Color fg,
    ActionListener accion
   ...
   */
  public static void configurarTablaExpedientes(
    JTable tabla,
  ...
  private static Color hoverColor(Color bg) {
    if (bg == AppColors.PRIMARIO) return AppColors.PRIMARIO_H;
    if (bg == AppColors.GRIS_BTN) return AppColors.GRIS_BTN_H;
    if (bg == AppColors.ROJO) return AppColors.ROJO_H;
    if (bg == AppColors.PURPURA) return AppColors.PURPURA_H;
    return bg.darker();
  }
}
